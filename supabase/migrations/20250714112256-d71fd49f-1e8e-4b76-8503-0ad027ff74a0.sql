-- Clean up inconsistent approval workflows for PO-07-03 and PO-07-04 with correct workflow type
-- This will enable the review action buttons that are currently locked

-- Delete all existing approval workflows for these specific POs using the correct workflow type
