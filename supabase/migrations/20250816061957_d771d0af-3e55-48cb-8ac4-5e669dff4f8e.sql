...
-- 3) Drop and recreate the view to ensure it has the correct structure
DROP VIEW IF EXISTS public.purchase_order_received_quantities;

CREATE VIEW public.purchase_order_received_quantities AS
SELECT 
